...
const appRoutes: Routes = [
  ...
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: REFUND_REQUEST_ROUTES, canActivate: [LoginGuard]},
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: REFUND_PRINT_ROUTES, canActivate: [LoginGuard]},
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: PROVISIONAL_COUNTER_ROUTES, canActivate: [LoginGuard]},
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: COUNTER_PRINT_ROUTES, canActivate: [LoginGuard]},
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: TAX_ROUTES, canActivate: [LoginGuard]},
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: TAX_PRINT_ROUTES, canActivate: [LoginGuard]},
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: TERMINATION_ROUTES, canActivate: [LoginGuard]},
  {path: '', component: BoxedLayoutComponent, data: {title: ''}, children: TERMINATION_PRINT_ROUTES, canActivate: [LoginGuard]},
