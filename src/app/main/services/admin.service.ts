...
export class AdminService {
    ...
    setAsInProgress(idRequest: number, agentId: number, intervenantId: number, intervantionDate: string): Observable<Response<number>> {
        return this.httpClient.get<Response<any>>
    ...
    getPageableActiveContracts(page: number, pageSize: number): Observable<Response<any>> {
    ...
    getPageableHistoryConsumptions(contractNo: string,
                                   ...
                                   dateFin: any,
                                   page: number,
                                   pageSize: number): Observable<Response<Array<ConsumptionModel>>> {
    ...
    getAllContractByNumClient(): Observable<Response<any>> {
        return this.httpClient.get<Response<any>>
