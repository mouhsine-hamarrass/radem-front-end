...
export class AdminService {
    ...
    getSubscriptionDetails(id: string): Observable<Response<SubscriptionModel>> {
        return this.httpClient.get<Response<SubscriptionModel>>(`${this.apiUrl}/subscription_request/${id}/details`, {headers: this.headers});
    }
    ...
    setAsReceivedSubscription(idRequest
                                  :
                                  number, agentId
                                  :
                                  number
    ...
    setAsInProgress(idRequest
                        :
                        number, agentId
                        :
                        number, intervenantId
                        :
                        number, intervantionDate
                        :
                        string
    ):
        Observable<Response<number>> {
    ...
    setAsDepositedCounter(idRequest
                              :
                              number, agentId
                              :
                              number
    ...
    setAsUnpaidVerification(idRequest
                                :
                                number, agentId
                                :
                                number
    ...
    getPageableActiveContracts(page
                                   :
                                   number, pageSize
                                   :
                                   number
    ...
    getPageableSettlements(contractNo: string, page: number, pageSize: number):
        Observable<Response<Array<PieceModel>>> {
        // tslint:disable-next-line:max-line-length
    ...
    getPageableHistoryConsumptions(contractNo: string, dateStart: any, dateEnd: any, page: number, pageSize: number):
        Observable<Response<Array<ConsumptionHistoryModel>>> {
        return this.httpClient.post<Response<Array<ConsumptionHistoryModel>>>(`${this.apiUrl}/consumptions?page=${page}&size=${pageSize}`,
            {
                contractNo,
                dateStart,
                dateEnd
    ...
    getPageableHistoryConsumptionsCurrentYear(contractNo: string):
        Observable<Response<Array<ConsumptionHistoryModel>>> {
        return this.httpClient.get<Response<Array<ConsumptionHistoryModel>>>(`${this.apiUrl}/consumptions/${contractNo}`);
    }

    getConsumptionReport(contractNo: string): Observable<Response<Array<ConsumptionReportModel>>> {
        return this.httpClient.get<Response<Array<ConsumptionReportModel>>>(`${this.apiUrl}/consumptions/graph/${contractNo}`, {headers: this.headers});
    }
...
// JSon server
    ...
    getSettlementsByContract(contractId ?: number)
        :
        Observable<Response<Array<any>>> {
        // tslint:disable-next-line:max-line-length
    ...
    getSettlements(contractNumber ?: number)
        :
        Observable<Response<Array<any>>> {
    ...
    getConsumptions(contractNumber
                        :
                        number
    ):
        Observable<Response<Array<any>>> {
    ...
    getMinMaxConsumption(contractNumber
                             :
                             number
    ):
        Observable<Response<any>> {
    ...
    getUserWithContract(contractNumber
                            :
                            number
    ):
        Observable<Response<any>> {
...
// Users
    ...
    getSettings()
        :
        Observable<Response<Array<Setting>>> {
        return this.httpClient.get<Response<any>>(`${this.apiUrl}/settings`);
    }

    getRegistrationQuestions()
        :
        Observable<Response<Array<RegistrationQuestionModel>>> {
    ...
    getAllDynamicPages()
        :
        Observable<Response<Array<DynamicModel>>> {
    ...
    getServices()
        :
        Observable<Response<Array<ServiceModel>>> {
