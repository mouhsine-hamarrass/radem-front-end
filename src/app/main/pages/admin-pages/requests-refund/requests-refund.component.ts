...
@Component({
  selector: 'app-requests-refund',
  templateUrl: './requests-refund.component.html',
  styleUrls: ['./requests-refund.component.scss']
})
export class RequestsRefundComponent implements OnInit {
    ...
    LoadRequests() {
        this.adminService.getPageableRefundRequest(this.page, this.pageSize, this.filter, this.sort)
            .subscribe(response => {
