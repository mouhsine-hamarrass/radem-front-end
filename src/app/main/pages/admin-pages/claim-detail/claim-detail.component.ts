...
export class ClaimDetailComponent implements OnInit {
  ...
  @ViewChild('ispublic') ispublic: ElementRef;
  ...
  get isPublic() {
    return this.commentForm.get('isPublic');
  }
...
// Add Comment
  addComment() {
    this.claim.feedbacks.push(new FeedbackModel(this.comment.value, new Date(), true, this.isPublic.value));
